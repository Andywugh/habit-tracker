...
const navigation: SidebarItem[] = [
  { name: '仪表盘', icon: HomeIcon, href: '/', current: true },
  { name: '添加习惯', icon: PlusIcon, href: '/habits/new' },
  { name: '统计分析', icon: ChartBarIcon, href: '/analytics' },
  { name: '日历视图', icon: CalendarIcon, href: '/calendar' },
