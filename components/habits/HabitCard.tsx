      ...
      <CardContent className="p-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className={clsx(
                  ...
                  {habit.frequency?.type === 'daily' ? '每日' : habit.frequency?.type === 'weekly' ? '每周' : '自定义'}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-1">
            ...
            {onDelete && (
              <Button
                ...
                size="sm"
                onClick={() => {
                  console.log('HabitCard删除按钮被点击，习惯:', habit.name, habit.id)
                  onDelete()
                }}
        ...
        {habit.reminder_time && (
          <div className="flex items-center space-x-2 mb-4 text-sm text-gray-600">
            ...
            <span>提醒时间: {habit.reminder_time}</span>
          </div>
        )}
